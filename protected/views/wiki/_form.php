...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'category', Lookup::items(Article::CATEGORY_TYPE)); ?>
	</div>
    ...
    <div class="row checkbox">
        <?php echo $form->checkBox($model,'isSendToWeibo');?>
        <?php echo $form->labelEx($model,'isSendToWeibo',array('class'=>'red'));?>
    </div>
